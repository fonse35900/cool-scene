...
function initDb(db) {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS vehicles (
      ...
      notes TEXT,
      investor_id INTEGER,
      vehicle_type TEXT DEFAULT 'stock' CHECK(vehicle_type IN ('stock','investidor')),
  ...
  if (!cols.find(c => c.name === 'vehicle_type')) {
    db.exec("ALTER TABLE vehicles ADD COLUMN vehicle_type TEXT DEFAULT 'stock'");
  }
